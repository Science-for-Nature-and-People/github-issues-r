...
function_test <- function(github_api_endpoint, url, repo_owner, repo_name, public = TRUE){
  
  # pulls the github issue, different method depending on private for not / needing a token
  if(isTRUE(public)){
...
# trying public repo
GITHUB_TOKEN = as.character(gh_token(api_url = "https://api.github.com/repos/maggieklope/leaflet-tutorial"))

# why doesn't this work? It works when I create a PAT through my github account through
