...
snapp_wg_scicomp_issues <- gh("/repos/SNAPP/snapp-wg-scicomp/issues", .api_url = "https://github.nceas.ucsb.edu/api/v3", owner = "SNAPP", repo = "snapp-wg-scicomp", .token = "6ee1afe72945dcffa5ccb1fcac57816927e5c5ea")  #%>%
  #{
  #data.frame(number = map_int(., "number"), #Calls the issue number
   #          id = map_int(., "id"), #Calls the issue id
    #         title = map_chr(., "title"), #Calls the title of the issue
