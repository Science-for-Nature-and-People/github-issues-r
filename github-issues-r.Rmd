...
library(tidyr)
library(curl)
library(keyring) # Look into this package more to access multiple tokens for the gh package to use.
...
#Here is a link on generating a token from github: https://docs.github.com/en/github/authenticating-to-github/creating-a-personal-access-token
...
gh_issues_private <- gh("/repos/Science-for-Nature-and-People/github-issues-r/issues", 
                        ...
                        .token = NULL # Token is set to NULL because GITHUB_PAT has been set in my .Renviron, if someone uses this code without it set it will fail.
                          ...
                          #keyring::key_get("Token", keyring = "Git_Credentials") 
...
snapp_wg_scicomp_issues <- gh("/repos/SNAPP/snapp-wg-scicomp/issues", 
                              ...
                              .token = keyring::key_get("Enterprise_Token", keyring = "Git_Credentials"), 
...
issues_httr <- GET
issues_httr_json <- content(issues_httr, type = "text")("https://api.github.com/repos/brunj7/nceas-r-packages/issues")
