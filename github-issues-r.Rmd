...
snapp_wg_scicomp_issues <- gh("/repos/SNAPP/snapp-wg-scicomp/issues", .api.url = "https://api.githug.nceas.ucsb.edu", owner = "SNAPP", repo = "snapp-wg-scicomp", .token = "7c5d4c32ded27c63bc30c8837eef8247347c8495")  #%>%
  #{
  #data.frame(number = map_int(., "number"), #Calls the issue number
   #          id = map_int(., "id"), #Calls the issue id
    #         title = map_chr(., "title"), #Calls the title of the issue
